...
class Block:
    def __init__(self, index, previous_hash, hash_analitico, student_signature, institute_signature):
        self.index = index
        self.previous_hash = previous_hash
        self.hash_analitico = hash_analitico
    ...
    def calculate_hash_block(self):
        block_string = f"{self.index}{self.previous_hash}{self.hash_analitico}{self.student_signature}{self.institute_signature}"
        self.hash = SHA3_256.new(block_string.encode()).hexdigest()
        return self.hash

    def recalculate_block(self, student_private_key, institute_private_key):
        self.student_signature = sing_function(self.hash_analitico, student_private_key)
    ...
    def info(self):
        return {
            ...
            "hash_analitico": self.hash_analitico.hexdigest() if hasattr(self.hash_analitico, "hexdigest") else self.hash_analitico,
    ...
    def verify_sing_student(self, public_key):
        return self.verify_signature(self.hash_analitico, self.student_signature, public_key)
